...
lv_obj_t *ui_StandbyScreen = NULL;lv_obj_t *ui_StandbyScreen_logo = NULL;lv_obj_t *ui_StandbyScreen_time = NULL;lv_obj_t *ui_StandbyScreen_Container1 = NULL;lv_obj_t *ui_StandbyScreen_wifiIcon = NULL;lv_obj_t *ui_StandbyScreen_bluetoothIcon = NULL;lv_obj_t *ui_StandbyScreen_updateIcon = NULL;lv_obj_t *ui_StandbyScreen_Image3 = NULL;
// event funtions
...
lv_obj_set_y( ui_StandbyScreen_time, -110 );
...
lv_obj_set_y( ui_StandbyScreen_Container1, -155 );
...
lv_obj_set_y( ui_StandbyScreen_Image3, 140 );
