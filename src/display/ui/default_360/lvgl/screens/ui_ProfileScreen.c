...
lv_obj_t *ui_ProfileScreen = NULL;lv_obj_t *ui_ProfileScreen_dials = NULL;lv_obj_t *ui_ProfileScreen_ImgButton1 = NULL;lv_obj_t *ui_ProfileScreen_contentPanel = NULL;lv_obj_t *ui_ProfileScreen_previousProfileBtn = NULL;lv_obj_t *ui_ProfileScreen_nextProfileBtn = NULL;lv_obj_t *ui_ProfileScreen_loadingSpinner = NULL;lv_obj_t *ui_ProfileScreen_profileDetails = NULL;lv_obj_t *ui_ProfileScreen_chooseButton = NULL;lv_obj_t *ui_ProfileScreen_simpleContent = NULL;lv_obj_t *ui_ProfileScreen_phasesLabel = NULL;lv_obj_t *ui_ProfileScreen_stepsLabel = NULL;lv_obj_t *ui_ProfileScreen_extendedContent = NULL;lv_obj_t *ui_ProfileScreen_Chart1 = NULL;lv_obj_t *ui_ProfileScreen_mainLabel = NULL;lv_obj_t *ui_ProfileScreen_profileName = NULL;lv_obj_t *ui_ProfileScreen_tempIcon = NULL;lv_obj_t *ui_ProfileScreen_targetIcon = NULL;lv_obj_t *ui_ProfileScreen_targetTemp2 = NULL;lv_obj_t *ui_ProfileScreen_targetDuration2 = NULL;
// event funtions
...
ui_object_set_themeable_style_property(ui_ProfileScreen_previousProfileBtn, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_SemiDark);
...
ui_object_set_themeable_style_property(ui_ProfileScreen_loadingSpinner, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_Dark);
ui_object_set_themeable_style_property(ui_ProfileScreen_loadingSpinner, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_ARC_COLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_ProfileScreen_loadingSpinner, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_ARC_OPA, _ui_theme_alpha_Dark);

ui_object_set_themeable_style_property(ui_ProfileScreen_loadingSpinner, LV_PART_INDICATOR| LV_STATE_DEFAULT, LV_STYLE_ARC_COLOR, _ui_theme_color_NiceWhite);
ui_object_set_themeable_style_property(ui_ProfileScreen_loadingSpinner, LV_PART_INDICATOR| LV_STATE_DEFAULT, LV_STYLE_ARC_OPA, _ui_theme_alpha_NiceWhite);
...
lv_obj_set_flex_align(ui_ProfileScreen_simpleContent, LV_FLEX_ALIGN_SPACE_EVENLY, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_SPACE_BETWEEN);
...
lv_chart_series_t* ui_ProfileScreen_Chart1_series_1 = lv_chart_add_series(ui_ProfileScreen_Chart1, lv_color_hex(0x2BA1F1), LV_CHART_AXIS_PRIMARY_Y);
...
lv_chart_series_t* ui_ProfileScreen_Chart1_series_2 = lv_chart_add_series(ui_ProfileScreen_Chart1, lv_color_hex(0x00BD58), LV_CHART_AXIS_SECONDARY_Y);
...
ui_object_set_themeable_style_property(ui_ProfileScreen_Chart1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_ProfileScreen_Chart1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_Dark);
ui_object_set_themeable_style_property(ui_ProfileScreen_Chart1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BORDER_COLOR, _ui_theme_color_Dark);
ui_object_set_themeable_style_property(ui_ProfileScreen_Chart1, LV_PART_MAIN| LV_STATE_DEFAULT, LV_STYLE_BORDER_OPA, _ui_theme_alpha_Dark);
